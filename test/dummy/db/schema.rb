...
ActiveRecord::Schema[7.1].define(version: 2024_07_23_174352) do
  create_table "jwt_sessions", force: :cascade do |t|
    t.string "jti", null: false
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["jti"], name: "index_jwt_sessions_on_jti", unique: true
    t.index ["user_id"], name: "index_jwt_sessions_on_user_id"
  end
